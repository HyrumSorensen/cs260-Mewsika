// const firstC = document.getElementById('first-c')
// const firstCSharp = document.getElementById('first-c#')
// const firstD = document.getElementById('first-d')
// const firstDSharp = document.getElementById('first-d#')
// const firstE = document.getElementById('first-e')
// const firstF = document.getElementById('first-f')
// const firstFSharp = document.getElementById('first-f#')
// const firstG = document.getElementById('first-g')
// const firstGSharp = document.getElementById('first-g#')
// const firstA = document.getElementById('first-a')
// const firstASharp = document.getElementById('first-a#')
// const firstB = document.getElementById('first-b')
// const secondC = document.getElementById('second-c')
// const secondCCSharp = document.getElementById('second-c#')
// const secondtD = document.getElementById('second-d')
// const secondDSharp = document.getElementById('second-d#')
// const secondE = document.getElementById('second-e')
// const secondF = document.getElementById('second-f')
// const secondFSharp = document.getElementById('second-f#')
// const secondG = document.getElementById('second-g')
// const secondGSharp = document.getElementById('second-g#')
// const secondA = document.getElementById('second-a')
// const secondASharp = document.getElementById('second-a#')
// const secondB = document.getElementById('second-b')
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function(t) {
    ...
    var notes = {
        ...
        "2Cs": new Howl({
            urls: [ "https://mczak.com/code/piano/assets/midia/545-C-sharp.mp3" ]
        }),
        "2D": new Howl({
